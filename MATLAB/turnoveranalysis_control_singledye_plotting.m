...
masterFolderPath = strcat(uigetdir('E:\PhD\Data analysis\temp_analysis_turnover\controls\Single color\SiR\analysis'),'\');
...
%%% Normalize the data
%signratio = sirsign./(tmrsign+sirsign);  % TMR only samples
signratio = tmrsign./(tmrsign+sirsign);  % SiR only samples
%%%
