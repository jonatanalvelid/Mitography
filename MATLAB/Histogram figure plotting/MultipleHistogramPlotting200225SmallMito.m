...
legendtext1 = sprintf('A > %.3f um^2', areathresh);
legendtext2 = sprintf('A < %.3f um^2', areathresh);
legendtext3 = sprintf('All mito');
...
n = 5; nbins = 30;
[~,binedges] = histcounts(log10(mitoareasted),nbins);
