...
colors = lines(2);
% 
% h1var = mitowidthBigFOVDIV17Ax;
% h2var = mitowidthBigFOVDIV17De;
% h3var = mitoareaBigFOVDIV17Ax;
% h4var = mitoareaBigFOVDIV17De;
% h5var = mitolengthOnlyFitBigFOVDIV17Ax;
% h6var = mitolengthOnlyFitBigFOVDIV17De;

h1var = mitowidthBigFOVDIV3Ax;
h2var = mitowidthBigFOVDIV3De;
h3var = mitoareaBigFOVDIV3Ax;
h4var = mitoareaBigFOVDIV3De;
h5var = mitolengthOnlyFitBigFOVDIV3Ax;
h6var = mitolengthOnlyFitBigFOVDIV3De;
