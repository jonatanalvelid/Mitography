...
h1var = filamentWidthPNZliveActinSinglePeak;
h2var = filamentWidthNPNZliveActinNonSinglePeak;
h3var = mitoActinDistPliveActinSinglePeak;
h4var = mitoActinDistNPliveActinNonSinglePeak;
